...
<?php
	...
	//$error=exec("/data2/www/ExonImpact2/jdk1.8.0_51/bin/java -cp \"Run.jar:lib_jar/*\" ccbb.hrbeu.exonimpact.test.Run ".$query_file_name. " con	figuration.txt > error1_".$query_file_name." 2>&1",$output1 );
	$sock = socket_create(AF_INET, SOCK_DGRAM, SOL_UDP);
	socket_bind($socket, '127.0.0.1', 8787);
